...
```{r FL-small-pests-plotly, echo=FALSE}
...
```{r map-FLpests2015, echo=FALSE, out.width="80%", fig.asp=1, dpi=300}
FL_pests_map <- map_FLpests2015 %>%
  ...
  labs(title = "2015 Estimated Pesticide Use by Florida County",
       ...
       subtitle = "(note: units of measure not indicated by data source)",
